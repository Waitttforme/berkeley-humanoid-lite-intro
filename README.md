...
技术展厅的“观看约 60 秒系统展演”可一键进入八章自动讲解流程，依次展示平台定位、信号链路、智慧服务、数字展品、实机证据、系统解剖、开放软件栈和开放构建路径；演示过程可暂停、继续、跳到下一章或退出。原第九部分“来源”及其导航已移除。
...
6. **构建**：以工程账册汇总 BOM、3D 打印、装配、固件刷写和部署的官方入口，并保留电机控制器刷写档案和全宽安全提示。
